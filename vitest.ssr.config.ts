...
// renders them in Node with no DOM present, so the SSR half of the <zag> and
// <zag-machine> contract (server-side throwaway service, serialized resume
// payload) is tested against actual output rather than a hand-built stand-in.
//
